...
const ControlLog = () => {
  ...
  const [rowEdit, setRowEdit] = useState<ControlLogItem | {}>({})
  ...
  const handlePopupDelete = (controlLog: ControlLogItem | {}) => {
   ...
   //Feature Edit
  const handlePopupEdit = (controlLog: ControlLogItem | {}) => {
    setRowEdit(controlLog);
  }
  return (
    <div className="h-full">
      ...
      {contextMenu.show && <Context onUpdate={handlePopupEdit} onDelete={handlePopupDelete} item={contextMenu.item} x = {contextMenu.x} y = {contextMenu.y} closeContextMenu={contextMenuClose}/>}
      {isLoading ? 
        <Loading/>
      :
        <>
